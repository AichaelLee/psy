<template>
  <div>
    ...
    <el-row>
      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6" :offset="1"  style="text-aligin:left"><FilenameOption v-model="filename" /></el-col>
      
      <el-col :xs="24"  :sm="24" :md="6" :lg="6" :xl="6"><AutoWidthOption v-model="autoWidth" /></el-col>
     <el-col :xs="24"  :sm="24" :md="6" :lg="6" :xl="6"> <BookTypeOption v-model="bookType" /></el-col>
